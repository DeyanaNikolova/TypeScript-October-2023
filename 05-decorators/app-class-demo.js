...
let Meneger = (() => {
    let _classDecorators = [withEmploymentDateOnPrototipe, withEmploymentDate];
    ...
    var Meneger = class {
        ...
        static {
            ...
            Meneger = _classThis = _classDescriptor.value;
    ...
    return Meneger = _classThis;
})();
const menager = new Meneger();
console.log(menager);
// console.log(menager.constructor.prototype);
function withEmploymentDateOnPrototipe(value, context) {
