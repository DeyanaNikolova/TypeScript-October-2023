...
let Project = (() => {
    ...
    return class Project {
        ...
        writeTest() {
            console.log("Tests are importanat!");
        }
        fixBugInProduction() {
...
function withBudget(actionBudget) {
    return function (target, context) {
        return function (...args) {
            const instance = this; // T -> our decorated class
            if (instance.budget > actionBudget) {
                ...
                console.log(`Insoficient budget for ${context.name.toString()}. Required ${actionBudget}, available ${instance.budget}!`);
            }
        };
    };
}
